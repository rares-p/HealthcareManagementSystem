...
namespace HealthcareManagementSystem.API.IntegrationTests.Base
{
    public class Seed
    {
        public static void InitializeDbForTests(HealthcareManagementSystemDbContext context)
        {
            ...
            {
                User.Create("test","Test", "1", DateTime.Now, "testauth").Value,
                User.Create("test", "Test", "2", DateTime.Now, "testauth").Value,
                User.Create("test", "Test", "3", DateTime.Now, "testauth").Value,
            };
